...
if(strpos($_SERVER['HTTP_REFERER'],'get_trackers.php') !==false){
    $validate ="validate_lpjs(this.value),";
}
else{
    $validate ="";
}
...
<?php } else { ?>
	...
	<select class="form-control input-sm" name="landing_page_id" id="landing_page_id" onchange="<?php if ($_POST['type' ] =='advlandingpage') echo $validate.' load_adv_text_ad_id(this.value);'; else  echo $validate.' load_text_ad_id( $(\'#aff_campaign_id\').val() ); ';  ?>">					
