...
<small><em><u>Make sure you test out all the links to make sure they
	...
	if ($_POST['method_of_promotion'] == 'directlink' && $_POST['tracker_type'] == 0) { 
		...
		$destination_url = 'http://' . getTrackingDomain() . get_absolute_url().'tracking202/redirect/dl.php?t202id=' . $tracker_id_public . $tracker_publisher_id . $tracking_variable_string;
	...
	if ($_POST['tracker_type'] == 2) { 
		...
		$destination_url = 'http://' . getTrackingDomain() . get_absolute_url().'tracking202/redirect/rtr.php?t202id=' . $tracker_id_public . $tracker_publisher_id . $tracking_variable_string;
		$html['destination_url'] = htmlentities($destination_url, ENT_QUOTES, 'UTF-8');
		printf('<br></br><small><strong>Destination URL:</strong></small><br/>
            <span class="infotext">This is the destination URL you should use in your PPC campaigns. 
            This destination URL stores your above settings,
