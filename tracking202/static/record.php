...
if ($tracker_row['landing_page_type'] == 0) {
    include_once (substr(dirname(__FILE__), 0, - 19) . '/tracking202/static/record_simple.php');
    die();
} elseif ($tracker_row['landing_page_type'] == 1) {
    include_once (substr(dirname(__FILE__), 0, - 19) . '/tracking202/static/record_adv.php');
    die();
}